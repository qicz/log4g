...
import (
	...
	pkg1 "github.com/acmestack/log4g/util/testdata/pkg/bar"
	pkg2 "github.com/acmestack/log4g/util/testdata/pkg/foo"
)
...
func TestReflectType(t *testing.T) {
	...
	data := []struct {
		...
		},
		{
			...
			reflect.Struct,
			"SamePkg",
			"github.com/acmestack/log4g/util/testdata/pkg/bar",
		},
		{
		...
		},
		{
			...
			reflect.Struct,
			"SamePkg",
			"github.com/acmestack/log4g/util/testdata/pkg/foo",
		},
		{
